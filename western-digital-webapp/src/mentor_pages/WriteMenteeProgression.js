...
function WriteMenteeProgression() {
  ...
  // Dummy Data
  const dummyMentees = [
    { menteekey: "mentee1", menteeName: "Alice Johnson" },
    { menteekey: "mentee2", menteeName: "Bob Smith" }
  ];

  const dummyMeetings = [
    { meetingkey: "meeting1", datetime: new Date().toISOString() },
    { meetingkey: "meeting2", datetime: new Date(Date.now() + 86400000).toISOString() }
  ];

  const user = { name: "Mentor John" }; // Dummy user
  ...
  useEffect(() => {
    if (selectedMentee) {
      // Load dummy meetings when mentee is selected
    ...
    <div className="write-mentee-progression">
      ...
      <div className="sidebarA">
        <div className="nav-buttonsA">
          ...
          <motion.button className="icon1" onClick={() => navigate("/write-mentee-progression")} whileHover={{ scale: 1.1 }} transition={{ duration: 0.1 }}>
            <img src={write} alt="write" />
          </motion.button>
          <motion.button className="icon" onClick={() => navigate("/assign-homework")} whileHover={{ scale: 1.1 }} transition={{ duration: 0.1 }}>
            <img src={hw} alt="hw" />
          </motion.button>
              ...
              <div className="main-content">
                <div className="mentor-mentee-container">
                  ...
                  <div className="dropdown-container">
                    ...
                    <select value={selectedMeeting} onChange={(e) => setSelectedMeeting(e.target.value)} disabled={!selectedMentee}>
                ...
                <div className="form-box">
                  <div className="question-group">
                    ...
                    <div className="radio-options">
                      <input type="radio" id="skipped-yes" name="skipped" value="yes" checked={skipped === "yes"} onChange={(e) => setSkipped(e.target.value)} />
                      <label htmlFor="skipped-yes">Yes</label>
                      <input type="radio" id="skipped-no" name="skipped" value="no" checked={skipped === "no"} onChange={(e) => setSkipped(e.target.value)} />
                ...
                <div className="form-box">
                  <div className="question-group">
                    ...
                    <div className="radio-options">
                      <input type="radio" id="homework-yes" name="finished_homework" value="yes" checked={finished_homework === "yes"} onChange={(e) => setFinishedHomework(e.target.value)} />
                      <label htmlFor="homework-yes">Yes</label>
                      <input type="radio" id="homework-no" name="finished_homework" value="no" checked={finished_homework === "no"} onChange={(e) => setFinishedHomework(e.target.value)} />
                      <label htmlFor="homework-no">No</label>
                    </div>
                ...
                <div className="form-box">
                  <div className="question-group">
                    ...
                    <div className="radio-options">
                      <input type="radio" id="attitude-very-good" name="attitude" value="very_good" checked={attitude_towards_learning === "very_good"} onChange={(e) => setAttitudeTowardsLearning(e.target.value)} />
                      <label htmlFor="attitude-very-good">Very Good</label>
                      <input type="radio" id="attitude-good" name="attitude" value="good" checked={attitude_towards_learning === "good"} onChange={(e) => setAttitudeTowardsLearning(e.target.value)} />
                      <label htmlFor="attitude-good">Good</label>
                      <input type="radio" id="attitude-bad" name="attitude" value="bad" checked={attitude_towards_learning === "bad"} onChange={(e) => setAttitudeTowardsLearning(e.target.value)} />
                      <label htmlFor="attitude-bad">Bad</label>
                    </div>
                ...
                <div className="comment-container">
                  <textarea value={newReport} onChange={(e) => setNewReport(e.target.value)} placeholder="Extra comments here" />
