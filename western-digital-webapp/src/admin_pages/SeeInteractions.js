...
function SeeInteractions() {
  ...
  useEffect(() => {
    setMentors([
      { userid: "mentor1", name: "John Smith" },
      { userid: "mentor2", name: "Jane Doe" },
    ]);

    setMentees([
      { userid: "mentee1", name: "Alice Johnson" },
      { userid: "mentee2", name: "Bob Brown" },
    ]);
  }, []);
            ...
            <div className="chat-containerA">
              <div className="search">
                <div className="filter-section">
                  ...
                  <select className="drop" value={selectedMentor} onChange={(e) => setSelectedMentor(e.target.value)}>
                  ...
                  <select className="drop" value={selectedMentee} onChange={(e) => setSelectedMentee(e.target.value)}>
                    ...
                    {mentees.map((mentee) => (
                      <option key={mentee.userid} value={mentee.userid}>{mentee.name}</option>
                    ))}
                  </select>
                </div>
              </div>
                    ...
                    return (
                      <Message
                        ...
                        model={{
                          ...
                          direction: message.sender === "Mentor" ? "outgoing" : "incoming",
                          position: "normal",
                        }}
                      />
                    );
